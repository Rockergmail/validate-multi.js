...
(function(window, document, undefined) {
    ...
    var FormValidator = function(formNameOrNode, fields, language, callback) {
        ...
        if(typeof callback === 'string' || callback == null){
            if(callback == null ) {
                this.callback = defaults.callbackBasic;
            } else {
